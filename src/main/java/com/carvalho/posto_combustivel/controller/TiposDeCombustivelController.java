...
import com.carvalho.posto_combustivel.service.TiposDeCombustivelService;
...
public class TiposDeCombustivelController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<TiposDeCombustivel> buscarTiposDeCombustivelPorId(
            @PathVariable(name = "id") Integer id) {
        return ResponseEntity.ok(tiposDeCombustivelService.buscarTiposDeCombustivelPorId(id));
    }

    @DeleteMapping("/{id}")
    public ResponseEntity<Void> deletarTiposDeCombustivelPorId(
            @PathVariable(name = "id") Integer id) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Void> alterarTipoDeCombustivel(
